...
if (pathname.includes("third.html")) {
  count = 0;
...
if (parentElements.length > 0) {
  parentElements.forEach((P, index) => {
    P.addEventListener("click", (e) => {
      if (timeExpired && pathname.includes("five.html")) return;
      ...
      if (e.target.classList.contains("child")) {
        ...
        if (isFirstChild && pathname.includes("third.html")) {
        ...
        } else if (isFirstChild && pathname.includes("four.html")) {
          e.target.style.backgroundColor = "green";
          e.target.style.color = "white";
          success.play();
          setTimeout(() => {
        ...
        } else if (isFirstChild && pathname.includes("five.html")) {
          e.target.style.backgroundColor = "green";
          e.target.style.color = "white";
          success.play();
          if (localStorage.getItem("count") === "1") {
            ...
            setTimeout(() => {
              window.location.href = "greetTwo.html";
            }, 2000);
          } else {
            setTimeout(() => {
    ...
    if (digitalClock) {
      ...
      const updateClock = () => {
        ...
        if (timeLeft <= 0) {
          ...
          if (pathname.includes("third.html")) {
            window.location.href = "four.html";
          } else if (pathname.includes("four.html")) {
            window.location.href = "five.html";
          } 
          else if (pathname.includes("five.html")) {
            if (localStorage.getItem("count") === "1") {
              setTimeout(() => {
                window.location.href = "greetOne.html";
              }, 2000);
